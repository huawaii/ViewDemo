...
public class MainActivity extends AppCompatActivity {
    ...
    private GLBlurWindowDrawable mBlurDrawable;
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragment = PlaceholderFragment_1.newInstance(0);
                    break;
                case 1:
                    fragment = PlaceholderFragment_2.newInstance(1);
                    break;
                case 2:
                    fragment = PlaceholderFragment_3.newInstance(2);
                    break;
                default:
                    fragment = PlaceholderFragment_1.newInstance(0);
            }
