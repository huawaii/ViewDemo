...
public class TopBar extends RelativeLayout {
    ...
    public TopBar(Context context, AttributeSet attrs) {
        ...
        //取出自定义属性 - 左侧
        leftTextColor = ta.getColor(R.styleable.TopBar_TB_leftTextColor, Color.BLACK);
        leftBackground = ta.getDrawable(R.styleable.TopBar_TB_leftBackground);
        leftText = ta.getString(R.styleable.TopBar_TB_leftText);

        //取出自定义属性 - 右侧
        rightTextColor = ta.getColor(R.styleable.TopBar_TB_rightTextColor, Color.BLACK);
        rightBackground = ta.getDrawable(R.styleable.TopBar_TB_rightBackground);
        rightText = ta.getString(R.styleable.TopBar_TB_rightText);

        //取出自定义属性 - 标题
        titleTextColor = ta.getColor(R.styleable.TopBar_TB_titleTextColor, Color.BLACK);
        titleTextSize = ta.getDimension(R.styleable.TopBar_TB_titleTextSize, 12);
        titleText = ta.getString(R.styleable.TopBar_TB_titleText);
